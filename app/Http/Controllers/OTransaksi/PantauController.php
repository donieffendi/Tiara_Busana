        ...
        return Datatables::of($pantau)
            ...
            ->addColumn('action', function ($row) {
                if (Auth::user()->divisi=="programmer" )
				{
                    ...
                    $btnEdit =   ($row->POSTED == 1) ? ' onclick= "alert(\'Transaksi ' . $row->NO_SP . ' sudah diposting!\')" href="#" ' : ' href="pantauedit/?idx=' . $row->NO_ID . '&tipx=edit';
                    ...
                    $btnPrivilege =
                        '
                                ...
                                <a class="dropdown-item btn btn-danger" target="_blank" href="pantaucetak/' . $row->NO_ID . '">
