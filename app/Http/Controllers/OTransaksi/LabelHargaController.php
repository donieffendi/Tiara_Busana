...
class LabelHargaController extends Controller
{
    ...
    {
        if ( $request->flagz == 'LB' && $request->golz == 'HG' ) {
    ...
    public function index(Request $request)
    {
        ...
        // ganti 3
        return view('otransaksi_harga_label.index')->with(['judul' => $this->judul, 'flagz' => $this->FLAGZ , 'golz' => $this->GOLZ]);
    ...
    {
        return view('otransaksi_harga_label.post');
    }
   ...
   public function edit( Request $request , Belibsnz $harga)
    {
		...
		$data = [
         ...
         return view('otransaksi_harga_label.edit', $data)
