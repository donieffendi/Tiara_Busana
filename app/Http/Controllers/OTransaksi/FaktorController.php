...
class FaktorController extends Controller
{
    ...
    {
        if ( $request->flagz == 'EN' ) {
            $this->judul = "Entry Factor S. Ideal";
        } else if ( $request->flagz == 'DF' ) {
            $this->judul = "Daftar Factor S. Ideal";
        }
    ...
    public function index(Request $request)
    {
        ...
        // ganti 3
        return view('otransaksi_faktor.index')->with(['judul' => $this->judul, 'flagz' => $this->FLAGZ]);
	...
	public function post(Request $request)
    {
        ...
        return view('otransaksi_faktor.post');
    }
    ...
    public function getFaktor(Request $request)
    {
        // ganti 5
   ...
   public function edit( Request $request , Retur $retur)
    {
		...
		$data = [
         ...
         return view('otransaksi_faktor.edit', $data)
