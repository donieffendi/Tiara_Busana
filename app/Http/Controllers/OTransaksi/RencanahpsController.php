...
// ganti 2
class RencanahpsController extends Controller
{
    /**
    ...
    {
        if ( $request->flagz == 'RC' ) {
            $this->judul = "Update Rencana Hapus";
        } 
    ...
    public function index(Request $request)
    {
        ...
        // ganti 3
        return view('otransaksi_rencanahps.index')->with(['judul' => $this->judul, 'flagz' => $this->FLAGZ]);
	...
	public function post(Request $request)
    {
        ...
        return view('otransaksi_rencanahps.post');
    }
    ...
    public function getRencanahps(Request $request)
    {
        // ganti 5
   ...
   public function edit( Request $request , Retur $retur)
    {
		...
		$data = [
         ...
         return view('otransaksi_rencanahps.edit', $data)
