...
class RUbahmarginController extends Controller
{
    public function report()
    {
        ...
        return view('oreport_ubahmargin.report')->with(['cbg' => $cbg])->with(['hasil' => []]);
    }
	
	
	 
	public function jasperUbahmarginReport(Request $request) 
	{
		$file 	= 'pon';
		...
		if($request->has('filter'))
		{
			...
			return view('oreport_ubahmargin.report')->with(['cbg' => $cbg])->with(['hasil' => $query]);
		}
