...
class RJadwal_pemantauanController extends Controller
{
    public function report()
    {
        ...
        return view('oreport_jadwal_pemantauan.report')->with(['cbg' => $cbg])->with(['hasil' => []]);
    }



	public function jasperJadwal_pemantauanReport(Request $request)
	{
		$file 	= 'rjadwal_pemantauan';
		...
		if($request->has('filter'))
		{
			...
			return view('oreport_jadwal_pemantauan.report')->with(['cbg' => $cbg])->with(['hasil' => $query]);
		}
