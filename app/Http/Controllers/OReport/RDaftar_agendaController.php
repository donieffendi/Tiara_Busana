...
class RDaftar_agendaController extends Controller
{
    public function report()
    {
        ...
        return view('oreport_daftar_agenda.report')->with(['cbg' => $cbg])->with(['hasil' => []]);
    }



	public function jasperDaftar_agendaReport(Request $request)
	{
		$file 	= 'rdaftar_agenda';
		...
		if($request->has('filter'))
		{
			...
			return view('oreport_daftar_agenda.report')->with(['cbg' => $cbg])->with(['hasil' => $query]);
		}
