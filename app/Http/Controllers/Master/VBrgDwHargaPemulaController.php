...
// ganti 2
class VBrgDwHargaPemulaController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('master_vbrgdw_harga_pemula.index');
    }
        ...
        return Datatables::of($vbrg)
            ...
            ->addColumn('action', function ($row) {
                if (Auth::user()->divisi == "programmer" || Auth::user()->divisi == "owner" || Auth::user()->divisi == "sales" || Auth::user()->divisi == 'pembelian') {
                    $url = "'" . url("vbrgdw-harga-pemula/delete/" . $row->NO_ID) . "'";
                    // batas
                    ...
                    $btnPrivilege =
                    '
                                    <a class="dropdown-item" href="vbrgdw-harga-pemula/edit/?idx=' . $row->NO_BUKTI . '&tipx=edit">
                                    <i class="fas fa-edit"></i>
                                        Edit
                                    </a>
                                     <a class="dropdown-item" target="_blank"
                                        href="' . url('vbrgdw-harga-pemula/print/' . $row->NO_BUKTI) . '">
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/vbrgdw-harga-pemula')
    ...
    public function edit(Request $request, Vbrg $vbrg)
    {
        ...
        return view('master_vbrgdw_harga_pemula.edit', [
            'header' => $header,
            'detail' => $detail,
            'idx'    => $idx,
        ]);
