        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{($tipx=='new')? url('/counter/store/') : url('/counter/update/'.$header->NO_ID ) }}" method="POST" name ="entri" id="entri" >
							...
							<div id="counterInfo" class="tab-pane active">	
								...
								<div class="form-group row">
									...
									<div class="col-md-3 form-group row special-input-label">
										...
										<input type="text" class="DIS_CNT" id="DIS_CNT" name="DIS_CNT" 
											value="{{$header->DIS_CNT}}" placeholder=" " >
										<label for="DIS_CNT">Diskon Customer</label>
									</div>
									<!-- tutupannya --> 
								...
								<div class="form-group row">
									...
									<!-- code text box baru -->
									<div class="col-md-2 form-group row special-input-label">
										<input class="form-control date" id="DIS_TGLMP" name="DIS_TGLMP" 
											data-date-format="dd-mm-yyyy" type="text" autocomplete="off" 
											value="{{ $header->DIS_TGLMP ? date('d-m-Y', strtotime($header->DIS_TGLMP)) : date('d-m-Y') }}">
										<label for="DIS_TGLMP">Tgl Mulai</label>
									</div>
									<!-- tutupannya -->
									...
									<!-- code text box baru -->
									<div class="col-md-2 form-group row special-input-label">
										<input class="form-control date" id="DIS_TGLSP" name="DIS_TGLSP" 
											data-date-format="dd-mm-yyyy" type="text" autocomplete="off" 
											value="{{ $header->DIS_TGLSP ? date('d-m-Y', strtotime($header->DIS_TGLSP)) : date('d-m-Y') }}">
									</div>
									<!-- tutupannya -->
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-1">
										...
										<label for="DIS_KHS">Kosmetik</label>
									</div>	
									<div class="col-md-1">
										<input type="checkbox" class="form-check-input" id="DIS_STS" name="DIS_STS" value="1" {{ ($header->DIS_STS == 1) ? 'checked' : '' }}>
										<label for="DIS_STS">VIP</label>
									</div>	
								</div>
								...
								<div class="form-group row">
									...
									<!-- code text box baru -->
									<div class="col-md-3 form-group row special-input-label">
										<input type="text" class="POT_PROM" id="POT_PROM" name="POT_PROM" 
											value="{{$header->POT_PROM}}" placeholder=" " >
										<label for="POT_PROM">Potongan Promosi</label>
									</div>
									<!-- tutupannya -->
								</div>
								...
								<div class="form-group row">
									...
									<!-- code text box baru -->
									<div class="col-md-2" >
										<label for="KEL_PT" class="form-label">Kelompok PT</label>
									</div>
									<div class="col-md-2">
										<select id="KEL_PT" class="form-control"  name="KEL_PT">
											<option value="A" {{ ($header->KEL_PT == 'A') ? 'selected' : '' }}>A</option>
											<option value="N" {{ ($header->KEL_PT == 'N') ? 'selected' : '' }}>N</option>
										</select>
									</div>	
									<!-- tutupannya -->
								</div>
								...
								<div class="form-group row">
									...
									<!-- code text box baru -->
									<div class="col-md-3 form-group row special-input-label">
										<input type="text" class="PER_NON" id="PER_NON" name="PER_NON" 
											value="{{$header->PER_NON}}" placeholder=" " >
										<label for="PER_NON">Periode Tidak Aktif</label>
									</div>
									<!-- tutupannya -->
								...
								<div class="form-group row">
									...
									<!-- code text box baru -->
									<div class="col-md-2" >
										<label for="CBAYAR" class="form-label">Jenis Bayar</label>
									</div>
									<div class="col-md-2">
									...
									<!-- code text box baru -->
									<div class="col-md-2 form-group row special-input-label">
										<input class="form-control date" id="BUKAC" name="BUKAC" 
											data-date-format="dd-mm-yyyy" type="text" autocomplete="off" 
											value="{{ $header->BUKAC ? date('d-m-Y', strtotime($header->BUKAC)) : date('d-m-Y') }}">
										<label for="BUKAC">Tgl Buka Counter</label>
									</div>
									<!-- tutupannya -->
									...
									<!-- code text box baru -->
									<div class="col-md-2 form-group row special-input-label">
										<input class="form-control date" id="TUTUPC" name="TUTUPC" 
											data-date-format="dd-mm-yyyy" type="text" autocomplete="off" 
											value="{{ $header->TUTUPC ? date('d-m-Y', strtotime($header->TUTUPC)) : date('d-m-Y') }}">
									</div>
									<!-- tutupannya -->
								</div>
								...
								<div class="form-group row">
									...
									<!-- code text box baru -->
									<div class="col-md-2" >
										<label for="BLOKIR" class="form-label">Blokir Budget</label>
									</div>
									<div class="col-md-2">
										<select id="BLOKIR" class="form-control"  name="BLOKIR">
											<option value="A" {{ ($header->BLOKIR == 'A') ? 'selected' : '' }}>A</option>
											<option value="N" {{ ($header->BLOKIR == 'N') ? 'selected' : '' }}>N</option>
										</select>
									</div>	
									<!-- tutupannya -->
								</div>
								...
								<div class="form-group row">
									...
									<!-- code text box baru -->
									<div class="col-md-2 form-group row special-input-label">
										<input class="form-control date" id="BLOKIRB" name="BLOKIRB" 
											data-date-format="dd-mm-yyyy" type="text" autocomplete="off" 
											value="{{ $header->BLOKIRB ? date('d-m-Y', strtotime($header->BLOKIRB)) : date('d-m-Y') }}">
										<label for="BLOKIRB">Tgl Blokir Budget</label>
									</div>
									<!-- tutupannya -->
								</div>
								...
								<div class="form-group row">
									...
									<!-- code text box baru -->
									<div class="col-md-3 form-group row special-input-label">
										<input type="text" class="PER_MIN" id="PER_MIN" name="PER_MIN" 
											value="{{$header->PER_MIN}}" placeholder=" " >
										<label for="PER_MIN">Periode Budget Minus</label>
									</div>
									<!-- tutupannya -->
								</div>
								...
								<div class="form-group row">
									...
									<!-- code text box baru -->
									<div class="col-md-2 form-group row special-input-label">
										<input type="text" class="B_MIN" id="B_MIN" name="B_MIN" 
											value="{{$header->B_MIN}}" placeholder=" " >
										<label for="B_MIN">Budget Minus</label>
									</div>
									<!-- tutupannya -->
									...
									<!-- code text box baru -->
									<div class="col-md-2 form-group row special-input-label">
										<input type="text" class="KALIB" id="KALIB" name="KALIB" 
											value="{{$header->KALIB}}" placeholder=" " >
										<label for="KALIB">Pengali Budget</label>
									</div>
									<!-- tutupannya -->
								</div>
						...
						<div class="mt-3 col-md-12 form-group row">
							<div class="col-md-4">
								<button hidden type="button" id='TOPX'  onclick="location.href='{{url('/counter/edit/?idx=' .$idx. '&tipx=top')}}'" class="btn btn-outline-primary">Top</button>
								<button hidden type="button" id='PREVX' onclick="location.href='{{url('/counter/edit/?idx='.$header->NO_ID.'&tipx=prev&kodex='.$header->CNT )}}'" class="btn btn-outline-primary">Prev</button>
								<button hidden type="button" id='NEXTX' onclick="location.href='{{url('/counter/edit/?idx='.$header->NO_ID.'&tipx=next&kodex='.$header->CNT )}}'" class="btn btn-outline-primary">Next</button>
								<button hidden type="button" id='BOTTOMX' onclick="location.href='{{url('/counter/edit/?idx=' .$idx. '&tipx=bottom')}}'" class="btn btn-outline-primary">Bottom</button>
							</div>
							<div class="col-md-5">
								<button hidden type="button" id='NEWX' onclick="location.href='{{url('/counter/edit/?idx=0&tipx=new')}}'" class="btn btn-warning">New</button>
								<button hidden type="button" id='EDITX' onclick='hidup()' class="btn btn-secondary">Edit</button>                    
								<button hidden type="button" id='UNDOX' onclick="location.href='{{url('/counter/edit/?idx=' .$idx. '&tipx=undo' )}}'" class="btn btn-info">Undo</button> 
							...
							<div class="col-md-3">
								...
								<!-- <button type="button" id='CLOSEX'  onclick="location.href='{{url('/counter' )}}'" class="btn btn-outline-secondary">Close</button> -->
...
//////////////////////////////////////////////////////////////////////////////////////////////////
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
				...
				Swal.fire({
	            	...
	            	loc = "{{ url('/counter/delete/'.$header->NO_ID) }}"  ;
	...
	function CariBukti() {
		...
		var cari = $("#CARI").val();
		var loc = "{{ url('/counter/edit/') }}" + '?idx={{ $header->NO_ID}}&tipx=search&kodex=' +encodeURIComponent(cari);
		window.location = loc;
