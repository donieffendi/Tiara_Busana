	...
	<div class="content-wrapper">
		<div class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 class="m-0">Report Perubahan Harga Barang</h1>
					</div>
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							<li class="breadcrumb-item active">Laporan Perubahan Harga Barang</li>
						</ol>
					</div>
				</div>
			</div>
	...
	<script>
		...
		function toggleButton(button) {
			...
			if (button.innerText === '+') {
				...
				$.ajax({
					url: "{{ route('rubbrgdw.browse_detail') }}",
					method: 'GET',
					...
					success: function(response) {
						...
						if (response.data && response.data.length > 0) {
							response.data.forEach((item, index) => {
								...
								detailHtml += `
									<tr>
										<td><div style="background-color: #f7d8b4; padding: 0.5rem;">${item.REC || ''}</div></td>
						...
						detailHtml += `
									<tr>
										...
										<td><div style="background-color: #ffc107; padding: 0.5rem; text-align: right; font-weight: bold;">${numberFormatGlobal(totalQty, 2)}</div></td>
										<td><div style="background-color: #ffc107; padding: 0.5rem; text-align: right; font-weight: bold;">${numberFormatGlobal(totalHargaLama, 2)}</div></td>
										<td><div style="background-color: #ffc107; padding: 0.5rem; text-align: right; font-weight: bold;">${numberFormatGlobal(totalHargaBaru, 2)}</div></td>
										<td colspan="8"></td>
										<td><div style="background-color: #ffc107; padding: 0.5rem; text-align: right; font-weight: bold;">${numberFormatGlobal(totalGrandTotal, 2)}</div></td>
										<td></td>
									</tr>
								</tbody>
							</table>
