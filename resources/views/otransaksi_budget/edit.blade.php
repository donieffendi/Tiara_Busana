        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{($tipx=='new')? url('/budget/store?flagz='.$flagz.'') : url('/budget/update/'.$header->NO_ID.'&flagz='.$flagz.'' ) }}" method="POST" name ="entri" id="entri" >
                        ...
                        <div class="tab-content mt-3">
                            ...
                            <div class="form-group row">
								...
								<div class="col-md-2">
									<input type="text" class="form-control PER" id="PER" name="PER" placeholder=""  value="{{$header->PER}}"  readonly >
								</div>
							...
							<div class="form-group row">
								<div class="col-md-1" align="left">
									<label for="QSB" class="form-label">Total Budget</label>
								</div>
								<div class="col-md-2">
									<input type="text"  onclick="select()" onkeyup="hitung()" class="form-control QSB" id="QSB" name="QSB" placeholder="" value="{{$header->QSB}}" style="text-align: right" readonly>
								</div>
								<div class="col-md-1" align="left">
								...
								<div class="col-md-2">
									<input type="text"  onclick="select()" onkeyup="hitung()" class="form-control NSB" id="NSB" name="NSB" placeholder="" value="{{$header->NSB}}" style="text-align: right" readonly>
								</div>
							</div>
							...
							<div class="form-group row">
								<div class="col-md-1" align="left">
									<label for="QOL" class="form-label">Total Order Lebih</label>
								</div>
								<div class="col-md-2">
									<input type="text"  onclick="select()" onkeyup="hitung()" class="form-control QOL" id="QOL" name="QOL" placeholder="" value="{{$header->QOL}}" style="text-align: right" readonly>
								</div>
								<div class="col-md-1" align="left">
									<label class="form-label">pcs</label>
								</div>
								...
								<div class="col-md-2">
									<input type="text"  onclick="select()" onkeyup="hitung()" class="form-control NOL" id="NOL" name="NOL" placeholder="" value="{{$header->NOL}}" style="text-align: right" readonly>
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-md-1">
									<input type="checkbox" class="form-check-input" id="STS_BLOKIR" name="STS_BLOKIR" value="1" {{ ($header->STS_BLOKIR == 1) ? 'checked' : '' }}>
									<label for="STS_BLOKIR"></label>
								</div>
							</div>

							<div class="form-group row">
								<div class="col-md-1" align="left">
									<label for="TQOL" class="form-label">Order lebih sp</label>
								</div>
								<div class="col-md-2">
									<input type="text"  onclick="select()" onkeyup="hitung()" class="form-control TQOL" id="TQOL" name="TQOL" placeholder="" value="{{$header->TQOL}}" style="text-align: right" readonly>
								</div>
								<div class="col-md-1" align="left">
									<label class="form-label">pcs</label>
								</div>
								...
								<div class="col-md-1" align="left">
									<label for="TNOL" class="form-label">Rp</label>
								</div>
								<div class="col-md-2">
									<input type="text"  onclick="select()" onkeyup="hitung()" class="form-control TNOL" id="TNOL" name="TNOL" placeholder="" value="{{$header->TNOL}}" style="text-align: right" readonly>
								</div>
							</div>
						...
						<div class="mt-3 col-md-12 form-group row">
							<div class="col-md-4">
								<button hidden type="button" id='TOPX'  onclick="location.href='{{url('/budget/edit/?idx=' .$idx. '&tipx=top&flagz='.$flagz.'' )}}'" class="btn btn-outline-primary">Top</button>
								<button hidden type="button" id='PREVX' onclick="location.href='{{url('/budget/edit/?idx='.$header->NO_ID.'&tipx=prev&flagz='.$flagz.'&buktix='.$header->NO_BUKTI )}}'" class="btn btn-outline-primary">Prev</button>
								<button hidden type="button" id='NEXTX' onclick="location.href='{{url('/budget/edit/?idx='.$header->NO_ID.'&tipx=next&flagz='.$flagz.'&buktix='.$header->NO_BUKTI )}}'" class="btn btn-outline-primary">Next</button>
								<button hidden type="button" id='BOTTOMX' onclick="location.href='{{url('/budget/edit/?idx=' .$idx. '&tipx=bottom&flagz='.$flagz.'' )}}'" class="btn btn-outline-primary">Bottom</button>
							</div>
							<div class="col-md-5">
								<button hidden type="button" id='NEWX' onclick="location.href='{{url('/budget/edit/?idx=0&tipx=new&flagz='.$flagz.'' )}}'" class="btn btn-warning">New</button>
								<button hidden type="button" id='EDITX' onclick='hidup()' class="btn btn-secondary">Edit</button>                    
								<button hidden type="button" id='UNDOX' onclick="location.href='{{url('/budget/edit/?idx=' .$idx. '&tipx=undo&flagz='.$flagz.'' )}}'" class="btn btn-info">Undo</button>  
							...
							<div class="col-md-3">
								...
								<!-- <button type="button" id='CLOSEX'  onclick="location.href='{{url('/budget?flagz='.$flagz.'' )}}'" class="btn btn-outline-secondary">Close</button> -->
...
// 		 mati();
	...
	// 	{
	// 		window.location ="{{url('/budget/delete/'.$header->NO_ID .'/?flagz='.$flagz.'' )}}";
	// 		//return true;
	// 	} 
	// 	return false;
	// }
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
				...
				Swal.fire({
	            	...
	            	loc = "{{ url('/budget/delete/'.$header->NO_ID) }}" + '?flagz=' + encodeURIComponent(flagz) ;
	...
	function closeTrans() {
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
	        	loc = "{{ url('/budget/') }}" + '?flagz=' + encodeURIComponent(flagz) ;
				window.location = loc ;
			} else {
				Swal.fire({
					icon: 'info',
	...
	function CariBukti() {
		...
		var flagz = "{{ $flagz }}";
		var cari = $("#CARI").val();
		var loc = "{{ url('/budget/edit/') }}" + '?idx={{ $header->NO_ID}}&tipx=search&flagz=' + encodeURIComponent(flagz) + '&buktix=' +encodeURIComponent(cari);
		window.location = loc;
