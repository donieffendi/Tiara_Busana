							...
							<div id="counterInfo" class="tab-pane active">
								...
								<div class="form-group row">
									...
									<div class="col-md-2 form-group row special-input-label">
										...
										<input type="text" class="PER" id="PER" name="PER"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2 form-group row special-input-label">
										<input type="text" class="NSB" id="NSB" name="NSB"
											value="{{$header->NSB}}" placeholder=" " style="text-align: right">
										<label for="NSB">Rp</label>
									</div>
								</div>
