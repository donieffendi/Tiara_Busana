...
<script>
  ...
  $(document).ready(function() {
        ...
        if(flagz != 'DF'){
            $("div.test_btn").html('<a class="btn btn-lg btn-md btn-success" href="{{url('faktor/edit?flagz='.$flagz.'&idx=0&tipx=new')}}"> <i class="fas fa-plus fa-sm md-3"></i></a>');
        }
        // $("div.test_btn").html('<a class="btn btn-lg btn-md btn-success" href="{{url('faktor/edit?flagz='.$flagz.'&idx=0&tipx=new')}}"> <i class="fas fa-plus fa-sm md-3" ></i></a');
