                ...
                <table class="table table-fixed table-striped table-border table-hover nowrap datatable" id="datatable">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th scope="col" style="text-align: right">CNT</th>
                            <th scope="col" style="text-align: left">Nama Counter</th>
                            <th scope="col" style="text-align: left">Diskon</th>
                            <th scope="col" style="text-align: left">Partisipasi</th>
...
<script>
  ...
  $(document).ready(function() {
        ...
        $("div.test_btn").html('<a class="btn btn-lg btn-md btn-success" href="{{url('diskon/edit?flagz='.$flagz.'&idx=0&tipx=new')}}"> <i class="fas fa-plus fa-sm md-3" ></i></a');
        ...
        window.toggleButton = function(button) {
            ...
            if (button.innerText === '+') {
                ...
                $.ajax({
                    url: '{{ route('get-detail-diskon') }}', // Define the route to fetch detail data
                    method: 'GET',
                    data: {
                        no_bukti: no_bukti
