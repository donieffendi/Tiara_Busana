								...
								<table id="datatable" class="table table-striped table-border">
									...
									<tbody id="detailPosting">
										<tr>
											...
											<td>
												<input name="BUKTX[]" id="BUKTX0" type="text" value=""
												class="form-control BUKTX" readonly >
											</td>
...
///////////////////////////////////////
					...
					for(i=0; i<resp.length; i++){
						html+=`<tr>
									...
									<td><input name='BUKTX[]' data-rowid=${i} id='BUKTX${i}' value="${resp[i].BUKT}" type='text' class='form-control BUKTX' readonly ></td>
