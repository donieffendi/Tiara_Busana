                                             ...
                                             <div class="modal-body">
                                                 <form id="columnToggleForm">
                                                     ...
                                                     <div class="form-check">
                                                         ...
                                                         <label class="form-check-label" for="columnNama">Nama
                                                             Supplier</label>

                                                     </div>
                                                     <div class="form-check">
                                                         <input class="form-check-input column-checkbox" type="checkbox"
                                                             value="7" id="columnKet" checked>
                                                         <label class="form-check-label" for="columnKet">Keterangan</label>
                                                     </div>
                                                     <div class="form-check">
                                                         <input class="form-check-input column-checkbox" type="checkbox"
                                                             value="8" id="columnUser" checked>
                                                         <label class="form-check-label" for="columnUser">User</label>
                                                     </div>
                                                     <div class="form-check">
                                                         <input class="form-check-input column-checkbox" type="checkbox"
                                                             value="9" id="columnPost" checked>
                                                         <label class="form-check-label" for="columnPost">Posted</label>
                                                     </div>
                                                     <div class="form-check">
                                                         <input class="form-check-input column-checkbox" type="checkbox"
                                                             value="10" id="columnSelesai" checked>
                                                         <label class="form-check-label"
                                                             for="columnSelesai">Selesai</label>
                                                     </div>
                                                 </form>
                                             </div>
