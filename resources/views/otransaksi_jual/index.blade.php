  ...
  $(document).ready(function() {
        var dataTable = $('.datatable').DataTable({
            ...
            [
                ...
                {data: 'TGL', name: 'TGL'},
                {data: 'TOTAL_QTY2', name: 'TOTAL_QTY2', render: $.fn.dataTable.render.number( ',', '.', 0, '' )},
