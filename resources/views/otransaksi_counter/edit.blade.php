        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{($tipx=='new')? url('/counter/store?flagz='.$flagz.'') : url('/counter/update/'.$header->NO_ID.'&flagz='.$flagz.'' ) }}" method="POST" name ="entri" id="entri" >
                        ...
                        <div class="tab-content mt-3">
							...
							<div id="main" class="tab-pane active">
								...
								<div class="form-group row">
									<div class="col-md-1" align="left">
										<label for="NO_BUKTI" class="form-label">Counter</label>
									</div>
									...
									<div class="col-md-1" align="left">								
										<label for="PER" class="form-label">Periode</label>
									</div>

									<div class="col-md-2">
										<input type="text" class="form-control PER" id="PER" name="PER" placeholder=""  value="{{$header->PER}}"   >
									</div>
								...
								<div class="form-group row">
									<div class="col-md-1" align="left">								
										<label for="NCNT" class="form-label">Nama</label>
									</div>
								
									<div class="col-md-7">
										<input type="text" class="form-control NCNT" id="NCNT" name="NCNT" placeholder=""  value="{{$header->NCNT}}"   >
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-2">
										<input type="text"  onclick="select()" onkeyup="hitung()" class="form-control MARGIN" id="MARGIN" name="MARGIN" placeholder="" value="{{$header->MARGIN}}" style="text-align: right" >
									</div>
								</div>			
								...
								<div class="form-group row">
									<div class="col-md-1" align="left">								
										<label for="ST_CNT" class="form-label">Status</label>
									</div>
								
									<div class="col-md-2">
										<input type="text" class="form-control ST_CNT" id="ST_CNT" name="ST_CNT" placeholder=""  value="{{$header->ST_CNT}}"   >
									</div>

									<div class="col-md-1" align="left">								
										<label for="ST_ORD" class="form-label">Order</label>
									</div>
								
									<div class="col-md-2">
										<input type="text" class="form-control ST_ORD" id="ST_ORD" name="ST_ORD" placeholder=""  value="{{$header->ST_ORD}}"   >
									</div>

									<div class="col-md-1" align="left">								
										<label for="KEL_PT" class="form-label">KPT</label>
									</div>

									<div class="col-md-2">
										<input type="text" class="form-control KEL_PT" id="KEL_PT" name="KEL_PT" placeholder=""  value="{{$header->KEL_PT}}"   >
									</div>
								</div>
							</div>
							...
							<div id="bayar" class="tab-pane">
								...
								<div class="form-group row">
									<div class="col-md-1" align="left">
										<label for="QBU" class="form-label">Budget</label>
									</div>
									<div class="col-md-2">
										<input type="text"  onclick="select()" onkeyup="hitung()" class="form-control QBU" id="QBU" name="QBU" placeholder="" value="{{$header->QBU}}" style="text-align: right" >
									</div>
									<div class="col-md-1" align="left">
									...
									<div class="col-md-1" align="left">
										<label for="NBU" class="form-label">Rp</label>
									</div>
									<div class="col-md-2">
										<input type="text"  onclick="select()" onkeyup="hitung()" class="form-control NBU" id="NBU" name="NBU" placeholder="" value="{{$header->NBU}}" style="text-align: right" >
									</div>
								</div>
								...
								<div class="form-group row">
									<div class="col-md-1" align="left">
										<label for="QOL" class="form-label"> Order Lebih</label>
									</div>
									<div class="col-md-2">
										<input type="text"  onclick="select()" onkeyup="hitung()" class="form-control QOL" id="QOL" name="QOL" placeholder="" value="{{$header->QOL}}" style="text-align: right" >
									</div>
									<div class="col-md-1" align="left">
										<label class="form-label">pcs</label>
									</div>
									...
									<div class="col-md-1" align="left">
										<label for="NOL" class="form-label">Rp</label>
									</div>
									<div class="col-md-2">
										<input type="text"  onclick="select()" onkeyup="hitung()" class="form-control NOL" id="NOL" name="NOL" placeholder="" value="{{$header->NOL}}" style="text-align: right" >
									</div>
								</div>

								<div class="form-group row">
									<div class="col-md-1" align="left">
										<label for="QBL" class="form-label">Pembelian</label>
									</div>
									<div class="col-md-2">
										<input type="text"  onclick="select()" onkeyup="hitung()" class="form-control QBL" id="QBL" name="QBL" placeholder="" value="{{$header->QBL}}" style="text-align: right" >
									</div>
									<div class="col-md-1" align="left">
										<label class="form-label">pcs</label>
									</div>
									...
									<div class="col-md-1" align="left">
										<label for="NBL" class="form-label">Rp</label>
									</div>
									<div class="col-md-2">
										<input type="text"  onclick="select()" onkeyup="hitung()" class="form-control NBL" id="NBL" name="NBL" placeholder="" value="{{$header->NBL}}" style="text-align: right" >
									</div>
								</div>
								...
								<div class="form-group row">
									<div class="col-md-1" align="left">
										<label for="QSB" class="form-label">Sisa</label>
									</div>
									<div class="col-md-2">
										<input type="text"  onclick="select()" onkeyup="hitung()" class="form-control QSB" id="QSB" name="QSB" placeholder="" value="{{$header->QSB}}" style="text-align: right" >
									</div>
									<div class="col-md-1" align="left">
										<label class="form-label">pcs</label>
									</div>
									...
									<div class="col-md-1" align="left">
										<label for="NSB" class="form-label">Rp</label>
									</div>
									<div class="col-md-2">
										<input type="text"  onclick="select()" onkeyup="hitung()" class="form-control NSB" id="NSB" name="NSB" placeholder="" value="{{$header->NSB}}" style="text-align: right" >
									</div>
								</div>
								...
								<div class="form-group row">
									<div class="col-md-1" align="left">
										<label for="TQBL" class="form-label">Pembelian</label>
									</div>
									<div class="col-md-2">
										<input type="text"  onclick="select()" onkeyup="hitung()" class="form-control TQBL" id="TQBL" name="TQBL" placeholder="" value="{{$header->TQBL}}" style="text-align: right" >
									</div>
									<div class="col-md-1" align="left">
										<label class="form-label">pcs</label>
									</div>
									...
									<div class="col-md-1" align="left">
										<label for="TNBL" class="form-label">Rp</label>
									</div>
									<div class="col-md-2">
										<input type="text"  onclick="select()" onkeyup="hitung()" class="form-control TNBL" id="TNBL" name="TNBL" placeholder="" value="{{$header->TNBL}}" style="text-align: right" >
									</div>
								</div>
						...
						<div class="mt-3 col-md-12 form-group row">
							<div class="col-md-4">
								<button hidden type="button" id='TOPX'  onclick="location.href='{{url('/counter/edit/?idx=' .$idx. '&tipx=top&flagz='.$flagz.'' )}}'" class="btn btn-outline-primary">Top</button>
								<button hidden type="button" id='PREVX' onclick="location.href='{{url('/counter/edit/?idx='.$header->NO_ID.'&tipx=prev&flagz='.$flagz.'&buktix='.$header->NO_BUKTI )}}'" class="btn btn-outline-primary">Prev</button>
								<button hidden type="button" id='NEXTX' onclick="location.href='{{url('/counter/edit/?idx='.$header->NO_ID.'&tipx=next&flagz='.$flagz.'&buktix='.$header->NO_BUKTI )}}'" class="btn btn-outline-primary">Next</button>
								<button hidden type="button" id='BOTTOMX' onclick="location.href='{{url('/counter/edit/?idx=' .$idx. '&tipx=bottom&flagz='.$flagz.'' )}}'" class="btn btn-outline-primary">Bottom</button>
							</div>
							<div class="col-md-5">
								<button hidden type="button" id='NEWX' onclick="location.href='{{url('/counter/edit/?idx=0&tipx=new&flagz='.$flagz.'' )}}'" class="btn btn-warning">New</button>
								<button hidden type="button" id='EDITX' onclick='hidup()' class="btn btn-secondary">Edit</button>                    
								<button hidden type="button" id='UNDOX' onclick="location.href='{{url('/counter/edit/?idx=' .$idx. '&tipx=undo&flagz='.$flagz.'' )}}'" class="btn btn-info">Undo</button>  
							...
							<div class="col-md-3">
								...
								<!-- <button type="button" id='CLOSEX'  onclick="location.href='{{url('/counter?flagz='.$flagz.'' )}}'" class="btn btn-outline-secondary">Close</button> -->
...
// 		 mati();
	...
	// 	{
	// 		window.location ="{{url('/counter/delete/'.$header->NO_ID .'/?flagz='.$flagz.'' )}}";
	// 		//return true;
	// 	} 
	// 	return false;
	// }
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
				...
				Swal.fire({
	            	...
	            	loc = "{{ url('/counter/delete/'.$header->NO_ID) }}" + '?flagz=' + encodeURIComponent(flagz) ;
	...
	function closeTrans() {
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
	        	loc = "{{ url('/counter/') }}" + '?flagz=' + encodeURIComponent(flagz) ;
				window.location = loc ;
			} else {
				Swal.fire({s
					icon: 'info',
	...
	function CariBukti() {
		...
		var flagz = "{{ $flagz }}";
		var cari = $("#CARI").val();
		var loc = "{{ url('/counter/edit/') }}" + '?idx={{ $header->NO_ID}}&tipx=search&flagz=' + encodeURIComponent(flagz) + '&buktix=' +encodeURIComponent(cari);
		window.location = loc;
