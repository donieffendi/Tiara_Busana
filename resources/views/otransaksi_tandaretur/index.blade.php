                    ...
                    <thead class="table-dark">
                        <tr>
                            <th scope="col" style="text-align: center">#</th>
                             ...
                             <th scope="col" style="text-align: left">P.L.U</th>
                             <th scope="col" style="text-align: left">Ukuran</th>
                             <th scope="col" style="text-align: left">Kemasan</th>
...
<script>
    $(document).ready(function() {
        ...
        $("div.test_btn").html(
            '<a class="btn btn-lg btn-success me-2" href="{{ url('tandaretur/edit?idx=0&tipx=new') }}">' +
    ...
    function postingData(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "{{ route('tandaretur.posting', ':id') }}".replace(':id', id),
                    type: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
