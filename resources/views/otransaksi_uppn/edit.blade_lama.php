                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form action="{{($tipx=='new')? url('/uppn/store?flagz='.$flagz.'&golz='.$golz.'') : url('/uppn/update/'.$header->NO_ID.'&flagz='.$flagz.'&golz='.$golz.'' ) }}" method="POST" name ="entri" id="entri" >
                                    ...
                                    <ul class="nav nav-tabs">
                                        <li class="nav-item active">
                                            <a class="nav-link active" href="#usulan" data-toggle="tab">Usulan</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#pengesahan" data-toggle="tab" >Pengesahan</a>
                                        </li>
                                    </ul>

                                    <div class="tab-content mt-3">

							            <div id="usulan" class="tab-pane active">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <input name="flagz" class="form-control flagz" id="flagz"
                                                    value="{{ $flagz }}" hidden>
                                                <input name="golz" class="form-control golz" id="golz"
                                                    value="{{ $golz }}" hidden>
                                                    ...
                                                    <table id="datatable" class="table table-striped table-bordered"
                                                        ...
                                                        <thead class="text-center">
                                                            <tr>
                                                                ...
                                                                <th style="width: 550px; white-space: nowrap;">Alasan</th>
                                                                <th style="width: 75px; white-space: nowrap;">Tanda</th>
                                                                <th></th>
                                                            </tr>
                                                        </thead>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach ($detail as $detail)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input name="TYPE[]" id="TYPE{{ $no }}"
                                                                            type="text" value="{{ $detail->TYPE }}"
							            ...
							            <div id="pengesahan" class="tab-pane">
		...
		var golz = "{{ $golz }}";
            ...
            function closeTrans() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
	        	        loc = "{{ url('/uppn/') }}" + '?flagz=' + encodeURIComponent(flagz) + '&golz=' + encodeURIComponent(golz) ;
                        window.location = loc;
                    } else {
                        Swal.fire({
                            icon: 'info',
            ...
            function CariBukti() {
                ...
                var golz = "{{ $golz }}";
		        var cari = $("#CARI").val();
		        var loc = "{{ url('/uppn/edit/') }}" + '?idx={{ $header->NO_ID}}&tipx=search&flagz=' + encodeURIComponent(flagz) + '&golz=' + encodeURIComponent(golz) + '&buktix=' +encodeURIComponent(cari);
                window.location = loc;
            ...
            function tambah() {
                ...
                html = `<tr>
                        ...
                        <td>
                            <input name='TYPE[]'   id='TYPE${idrow}' type='text' class='form-control  TYPE' required>
                        </td>
                        <td>
