...
<div class="content-wrapper">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form
                                action="{{ $tipx == 'new' ? url('/uppn/store?flagz=' . $flagz . '') : url('/uppn/update/' . $header->NO_ID . '&flagz=' . $flagz . '') }}"
                                ...
                                <div class="mt-3 col-md-12 form-group row">
                                    <div class="col-md-4">
                                        <button hidden type="button" id='TOPX'
                                            onclick="location.href=`{{ url('/uppn/edit/?idx=' . $idx . '&tipx=top&flagz=' . $flagz . '') }}`"
                                            class="btn btn-outline-primary">Top</button>
                                        <button hidden type="button" id='PREVX'
                                            onclick="location.href=`{{ url('/uppn/edit/?idx=' . $header->NO_ID . '&tipx=prev&flagz=' . $flagz . '&buktix=' . $header->NO_BUKTI) }}`"
                                            class="btn btn-outline-primary">Prev</button>
                                        <button hidden type="button" id='NEXTX'
                                            onclick="location.href=`{{ url('/uppn/edit/?idx=' . $header->NO_ID . '&tipx=next&flagz=' . $flagz . '&buktix=' . $header->NO_BUKTI) }}`"
                                            class="btn btn-outline-primary">Next</button>
                                        <button hidden type="button" id='BOTTOMX'
                                            onclick="location.href=`{{ url('/uppn/edit/?idx=' . $idx . '&tipx=bottom&flagz=' . $flagz . '') }}`"
                                            class="btn btn-outline-primary">Bottom</button>
                                    </div>
                                    <div class="col-md-5">
                                        <button hidden type="button" id='NEWX'
                                            onclick="location.href=`{{ url('/uppn/edit/?idx=0&tipx=new&flagz=' . $flagz . '') }}`"
                                        ...
                                        <button hidden type="button" id='UNDOX'
                                            onclick="location.href=`{{ url('/uppn/edit/?idx=' . $idx . '&tipx=undo&flagz=' . $flagz . '') }}`"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <!-- <button type="button" id='CLOSEX'  onclick="location.href='{{ url('/uppn?flagz=' . $flagz . '') }}'" class="btn btn-outline-secondary">Close</button> -->
    ...
    <script>
        ...
        // 	{
        // 		window.location ="{{ url('/uppn/delete/' . $header->NO_ID . '/?flagz=' . $flagz . '') }}";
        // 		//return true;
        // 	}
        // 	return false;
        // }
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        ...
                        loc = "{{ url('/uppn/delete/' . $header->NO_ID) }}" + '?flagz=' +
        ...
        function CariBukti() {
            ...
            var flagz = "{{ $flagz }}";
            var cari = $("#CARI").val();
            var loc = "{{ url('/uppn/edit/') }}" + '?idx={{ $header->NO_ID }}&tipx=search&flagz=' + encodeURIComponent(
