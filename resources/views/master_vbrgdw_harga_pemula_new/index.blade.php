                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="columnToggleForm">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input column-checkbox" type="checkbox"
                                                            value="5" id="columnKodes" checked>
                                                        <label class="form-check-label" for="columnKodes">Supplier</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input column-checkbox" type="checkbox"
                                                            value="6" id="columnNamas" checked>
                    ...
                    <tbody>
                                ...
                                <div class="tab-content mt-3">
                                    ...
                                    <a class="btn btn-success btn-lg"
                                        href="{{ url('vbrgdw-harga-pemula/edit?idx=0&tipx=new') }}">
...
@section('javascripts')
    ...
    <script>
        ...
        // 	<a class="btn btn-primary btn-lg"
        // 	   href="{{ url('vbrgdw-harga-pemula-new/edit?idx=0&tipx=new') }}">
        ...
        // `);
            ...
            window.toggleButton = function(button) {
                ...
                if (button.innerText === '+') {
                    ...
                    $.ajax({
                        url: '{{ route('get-detail-vbrgdw-harga-pemula') }}', // Define the route to fetch detail data
                        method: 'GET',
                        data: {
                            no_bukti: no_bukti
