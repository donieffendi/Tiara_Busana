                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ url('/vbrgdw-harga-pemula_new/store/') }}" method="POST" name="entri"
                                    id="entri">
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('#KODES').select2({
                    ...
                    allowClear: true,
                    ajax: {
                        url: "{{ url('vbrgdw-harga-pemula_new/browse_kodes') }}",
                        dataType: 'json',
                        delay: 250,
                ...
                function getVbrgdw(id) {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: "{{ url('vbrgdw-harga-pemula_new/browse') }}",
                        data: {
                            KODES: id
                        },
            ...
            function closeTrans() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        loc = "{{ url('/vbrgdw-harga-pemula_new/') }}";
                        window.location = loc;
                    } else {
                        Swal.fire({
                            icon: 'info',
