                                    ...
                                    <div class="tab-content mt-3">
                                        ...
                                        <div id="main" class="tab-pane active">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control NOTRANS" id="NOTRANS"
                                                        name="NOTRANS" placeholder="" value="{{ $header->NOTRANS }}"
                                                        readonly>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-1">
                                                    <select id="TYPE" class="form-control" name="TYPE">
                                                        <option value="CASH"
                                                            {{ $header->TYPE == 'CASH' ? 'selected' : '' }}>Cash</option>
                                                        <option value="KREDIT"
                                                            {{ $header->TYPE == 'KREDIT' ? 'selected' : '' }}>Kredit
                                                        </option>
                                                    </select>
                                                </div>
                                                ...
                                                <!-- tutupannya -->
                                                <div class="col-md-2">
                                                    <input class="form-control date" id="TGTF" name="TGTF"
                                                        data-date-format="dd-mm-yyyy" type="text" autocomplete="off"
                                                        value="{{ date('d-m-Y', strtotime($header->TGTF)) }}">
                                                </div>
                                            ...
                                            <div style="overflow-y:scroll; height:200px;" class="col-md-12 scrollable"
                                                align="right">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($detail as $detail)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input name="NO_TRM[]" id="NO_TRM{{ $no }}"
                                                                        type="text" class="form-control NO_TRM "
                                                                        value="{{ $detail->NO_TRM }}"
                                                                        onblur="browseBarang({{ $no }})">
                                                                </td>

                                                                <td>
                                                                    <input name="CNT[]" id="CNT{{ $no }}"
                                                                        type="text" class="form-control CNT "
                                                                        value="{{ $detail->CNT }}">
                                                                </td>
                                                                <td>
                                                                    <input name="ST_PJK[]" id="ST_PJK{{ $no }}"
                                                                        type="text" value="{{ $detail->ST_PJK }}"
                                                                        class="form-control ST_PJK" readonly required>
                                                                </td>
                                                                <td>
                                                                    <input name="TGL_TRM[]"
                                                                        id	="TGL_TRM{{ $no }}" type="text"
                                                                        class="date form-control text_input TGL_TRM"
                                                                        data-date-format="dd-mm-yyyy"
                                                                        value="{{ $detail->TGL_TRM == '0000-00-00' ? '00-00-0000' : date('d-m-Y', strtotime($detail->TGL_TRM)) }}">
                                                                </td>
                                                                <td>
                                                                    <input name="NO_SP[]" id="NO_SP{{ $no }}"
                                                                        type="text" value="{{ $detail->NO_SP }}"
                                                                        class="form-control NO_SP" readonly required>
                                                                </td>

                                                                <td><input name="TOTAL[]" onclick="select()"
                                                                        onkeyup="hitung()" value="{{ $detail->TOTAL }}"
                                                                        id="TOTAL{{ $no }}" type="text"
                                                                        style="text-align: right"
                                                                        class="form-control TOTAL text-primary"></td>
                                                                <td><input name="PPN[]" onclick="select()"
                                                                        onkeyup="hitung()" value="{{ $detail->PPN }}"
                                                                        id="PPN{{ $no }}" type="text"
                                                                        style="text-align: right"
                                                                        class="form-control PPN text-primary"></td>
                                                                <td><input name="TOTALX[]" onclick="select()"
                                                                        onkeyup="hitung()" value="{{ $detail->TOTALX }}"
                                                                        id="TOTALX{{ $no }}" type="text"
                                                                        style="text-align: right"
                                                                        class="form-control TOTALX text-primary" readonly>
                                                                </td>

                                                                <td>
                                                                    <input name="ACNO[]" id="ACNO{{ $no }}"
                                                                        type="text" value="{{ $detail->ACNO }}"
                                                                        class="form-control ACNO" readonly required>
                                                                </td>
                                                                <td>
                                                                    <input name="NACNO[]" id="NACNO{{ $no }}"
                                                                        type="text" value="{{ $detail->NACNO }}"
             ...
             <a type="button" id='PLUSX' onclick="tambah()" class="fas fa-plus fa-sm md-3" style="font-size: 20px" ></a>
                                            ...
                                            <div class="tab-content mt-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-3 input-group">
                                                        <input type="text" class="form-control uppercase KOTA"
                                                            id="KOTA" name="KOTA"
                                                            placeholder=""value="{{ $header->KOTA }}"
                                                    ...
                                                    <div class="col-md-2">
                                                        <input type="text" onclick="select()" onkeyup="hitung()"
                                                            class="form-control TRETUR" id="TRETUR" name="TRETUR"
                                                            placeholder="" value="{{ $header->RETUR }}"
                                                    ...
                                                    <div class="col-md-2">
                                                        <input type="text" onclick="select()" onkeyup="hitung()"
                                                            class="form-control TTOTALX" id="TTOTALX" name="TTOTALX"
                                                            placeholder="" value="{{ $header->TOTALX }}"
                                                            style="text-align: right" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-3 input-group">
                                                        <input type="text" class="form-control uppercase ALAMAT"
                                                            id="ALAMAT" name="ALAMAT"
                                                            placeholder=""value="{{ $header->ALAMAT }}"
                                                            style="text-align: left">
                                                    </div>
                                                    ...
                                                    <div class="col-md-2">
                                                        <input type="text" onclick="select()" onkeyup="hitung()"
                                                            class="form-control TBLAIN" id="TBLAIN" name="TBLAIN"
                                                            placeholder="" value="{{ $header->BLAIN }}"
                                                            style="text-align: right" readonly>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2">
                                                        <input type="text" onclick="select()" onkeyup="hitung()"
                                                            class="form-control TLAIN" id="TLAIN" name="TLAIN"
                                                            placeholder="" value="{{ $header->LAIN }}"
                                                            style="text-align: right" readonly>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <input type="text" onclick="select()" onkeyup="hitung()"
                                                            class="form-control TBADM" id="TBADM" name="TBADM"
                                                            placeholder="" value="{{ $header->BADM }}"
                                                            style="text-align: right" readonly>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <input type="text" onclick="select()" onkeyup="hitung()"
                                                            class="form-control TREFUND" id="TREFUND" name="TREFUND"
                                                            placeholder="" value="{{ $header->REFUND }}"
                                                            style="text-align: right" readonly>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2">
                                                        <input type="text" onclick="select()" onkeyup="hitung()"
                                                            class="form-control TTOTAL" id="TTOTAL" name="TTOTAL"
                                                            placeholder="" value="{{ $header->TOTAL }}"
                                                            style="text-align: right" readonly>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <input type="text" onclick="select()" onkeyup="hitung()"
                                                            class="form-control TPROMOS" id="TPROMOS" name="TPROMOS"
                                                            placeholder="" value="{{ $header->PROMOS }}"
                                                            style="text-align: right" readonly>
                                                    </div>
                                                </div>
                                        ...
                                        <div id="bayar" class="tab-pane">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-3 input-group">
                                                    ...
                                                    <button type="button" class="btn btn-primary"
                                                        onclick="browseSup()"><i class="fa fa-search"></i></button>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control CARA" id="CARA"
                                                        name="CARA" placeholder="" value="{{ $header->CARA }}">
                                                </div>

                                                <div class="col-md-1">
                                                    <input type="checkbox" class="form-check-input" id="EMAIL"
                                                        name="EMAIL" value="1"
                                                        {{ $header->EMAIL == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control KLB" id="KLB"
                                                        name="KLB" placeholder="" value="{{ $header->KLB }}">
                                                </div>

                                                <div class="col-md-2">
                                                    <input type="text" class="form-control ANB" id="ANB"
                                                        name="ANB" placeholder="" value="{{ $header->ANB }}">
                                                </div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-beta.1/dist/js/select2.min.js"></script> -->
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $("#TRETUR").autoNumeric('init', {
                    aSign: '<?php echo ''; ?>',
                    vMin: '-999999999.99'
                });
                $("#TTOTALX").autoNumeric('init', {
                    aSign: '<?php echo ''; ?>',
                    vMin: '-999999999.99'
                });
                $("#TBLAIN").autoNumeric('init', {
                    aSign: '<?php echo ''; ?>',
                    vMin: '-999999999.99'
                });
                        ...
                        success: function(response) {
                            ...
                            for (i = 0; i < resp.length; i++) {
                                ...
                                dTableBSup.row.add([
                                    ...
                                    .GOLONGAN + '\',\'' + resp[i].CARA + '\',\'' + resp[i]
                                    .NAMA_B + '\',\'' + resp[i].NO_REK + '\')">' + resp[i]
                                    .KODES + '</a>',
                                    resp[i].KODES,
                                    resp[i].NAMAS,
                                    resp[i].ALAMAT,
                ...
                chooseSup = function(KODES, NAMAS, ALAMAT, KOTA, GOLONGAN, CARA, NAMA_B, NO_REK) {
