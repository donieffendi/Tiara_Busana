                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label><strong>Jenis Busana</strong></label><br>

                                    <input type="radio" name="jenis_busana" value="PUTUS" checked>
                                    BUSANA PUTUS

                                    <input type="radio" name="jenis_busana" value="KONSINYASI" class="ms-3">
                                    BUSANA KONSINYASI
                                </div>
                                ...
                                <table class="table table-fixed table-striped table-border table-hover nowrap datatable"
                                    ...
                                    <thead class="table-dark">
                                        <tr>
                                            ...
                                            <th scope="col" style="text-align: left">No Pajak</th>
                                            <th scope="col" style="text-align: right">Tgl</th>
                                            <th scope="col" style="text-align: left">Sup</th>
                                            ...
                                            <th scope="col" style="text-align: left">KLB</th>
                                            <th scope="col" style="text-align: left">Prnt</th>
                                        </tr>
                                    </thead>
        ...
        $(document).ready(function() {
            ...
            var dataTable = $('.datatable').DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        d.flagz = $('#flagz').val();
                        d.jenis_busana = $('input[name="jenis_busana"]:checked').val();
                    },
                },
            ...
            $("div.test_btn").html(
                '<a class="btn btn-lg btn-md btn-success" href="{{ url('tagi/edit?flagz=' . $flagz . '&idx=0&tipx=new') }}"> <i class="fas fa-plus fa-sm md-3" ></i></a'
            );
            $('input[name="jenis_busana"]').on('change', function() {
            ...
            window.toggleButton = function(button) {
                ...
                if (button.innerText === '+') {
                    ...
                    $.ajax({
                        url: '{{ route('get-detail-tagi') }}', // Define the route to fetch detail data
                        method: 'GET',
                        data: {
                            no_bukti: no_bukti
