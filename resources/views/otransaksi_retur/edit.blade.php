                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form
                                    action="{{ $tipx == 'new' ? url('/retur/store?flagz=' . $flagz . '') : url('/retur/update/' . $header->NO_ID . '&flagz=' . $flagz . '') }}"
                                    ...
                                    <div class="tab-content mt-3">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2">
                                                <input type="text" class="form-control" value="{{ Auth::user()->CBG }}"
                                                    name="CBG" id="CBG" readonly>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input name="TGL_MULAI[]"
                                                                    id	="TGL_MULAI{{ $no }}" type="text"
                                                                    class="date form-control text_input TGL_MULAI"
                                                                    data-date-format="dd-mm-yyyy"
                                                                    value="{{ $detail->tgl_mulai == '0000-00-00' ? '00-00-0000' : date('d-m-Y', strtotime($detail->tgl_mulai)) }}">
                                                            </td>

                                                            <td><input name="QTYK[]" onclick="select()"
                                                                    onkeyup="hitung()" value="{{ $detail->qtyk }}"
                                                                    id="QTYK{{ $no }}" type="text"
                                                                    style="text-align: right"
                                                                    class="form-control QTYK text-primary"></td>
                                                            <td><input name="HARGA[]" onclick="select()"
                                                                    onkeyup="hitung()" value="{{ $detail->harga }}"
                                                                    id="HARGA{{ $no }}" type="text"
                                                                    style="text-align: right"
                                                                    class="form-control HARGA text-primary"></td>
                                    ...
                                    <div class="mt-3 col-md-12 form-group row">
                                        <div class="col-md-4">
                                            <button hidden type="button" id='TOPX'
                                                onclick="location.href='{{ url('/retur/edit/?idx=' . $idx . '&tipx=top&flagz=' . $flagz . '') }}'"
                                                class="btn btn-outline-primary">Top</button>
                                            <button hidden type="button" id='PREVX'
                                                onclick="location.href='{{ url('/retur/edit/?idx=' . $header->NO_ID . '&tipx=prev&flagz=' . $flagz . '&buktix=' . $header->NO_BUKTI) }}'"
                                                class="btn btn-outline-primary">Prev</button>
                                            <button hidden type="button" id='NEXTX'
                                                onclick="location.href='{{ url('/retur/edit/?idx=' . $header->NO_ID . '&tipx=next&flagz=' . $flagz . '&buktix=' . $header->NO_BUKTI) }}'"
                                                class="btn btn-outline-primary">Next</button>
                                            <button hidden type="button" id='BOTTOMX'
                                                onclick="location.href='{{ url('/retur/edit/?idx=' . $idx . '&tipx=bottom&flagz=' . $flagz . '') }}'"
                                                class="btn btn-outline-primary">Bottom</button>
                                        </div>
                                        <div class="col-md-5">
                                            <button hidden type="button" id='NEWX'
                                                onclick="location.href='{{ url('/retur/edit/?idx=0&tipx=new&flagz=' . $flagz . '') }}'"
                                            ...
                                            <button hidden type="button" id='UNDOX'
                                                onclick="location.href='{{ url('/retur/edit/?idx=' . $idx . '&tipx=undo&flagz=' . $flagz . '') }}'"
    ...
    <script>
                            ...
                            for (i = 0; i < resp.length; i++) {
                                ...
                                dTableBBarang.row.add([
                                    ...
                                    resp[i].KD_BRG + '\', \'' + resp[i].NA_BRG + '\',\'' + resp[
                                        i].BARCODE + '\',\'' + resp[i].TGL_MULAI + '\',\'' +
                                    resp[i].QTY + '\',\'' + resp[i].HARGA + '\')">' + resp[i]
                                    .KD_BRG + '</a>',
                                    resp[i].NA_BRG,
                                ]);
                            }
        ...
        function hidup() {
            ...
            for (i = 0; i <= jumlahdata; i++) {
                ...
                $("#TGL_MULAI" + i.toString()).attr("disabled", false);
                $("#QTYK" + i.toString()).attr("readonly", false);
        ...
        function mati() {
            ...
            for (i = 0; i <= jumlahdata; i++) {
                ...
                $("#BARCODE" + i.toString()).attr("readonly", true);
                $("#NA_BRG" + i.toString()).attr("readonly", true);
                $("#TGL_MULAI" + i.toString()).attr("disabled", true);
                $("#QTYK" + i.toString()).attr("readonly", true);
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        ...
                        loc = "{{ url('/retur/delete/' . $header->NO_ID) }}" + '?flagz=' +
        ...
        function CariBukti() {
            ...
            var flagz = "{{ $flagz }}";
            var cari = $("#CARI").val();
            var loc = "{{ url('/retur/edit/') }}" + '?idx={{ $header->NO_ID }}&tipx=search&flagz=' + encodeURIComponent(
        ...
        function tambah() {
            ...
            html = `<tr>
				...
				<td>
					<input name="TGL_MULAI[]" ocnlick='select()' id="TGL_MULAI${idrow}" type="text" class="date form-control text_input TGL_MULAI" data-date-format="dd-mm-yyyy" value="<?php if (isset($_POST['tampilkan'])) {
     } else {
