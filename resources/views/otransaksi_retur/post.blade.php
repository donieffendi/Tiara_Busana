                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="entri" action="{{ url('retur/posting') }}" method="POST">
                                    @csrf
                                        ...
                                        <table id="datatable" class="table table-striped table-border">
                                            ...
                                            <tbody id="detailPosting">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input name="NO_BUKTIX[]" id="NO_BUKTIX0" type="text"
                                                            value="" class="form-control NO_BUKTIX" readonly>
                                                    </td>
            ...
            function getPost() {
                ...
                $.ajax({
                    ...
                    success: function(resp) {
                        ...
                        $(".TOTALX").autoNumeric('init', {
                            aSign: '<?php echo ''; ?>',
                            vMin: '-999999999.99'
                        });
                        $(".TOTALX").autoNumeric('update');
                        $(".NETTX").autoNumeric('init', {
                            aSign: '<?php echo ''; ?>',
                            vMin: '-999999999.99'
                        });
