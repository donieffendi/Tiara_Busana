                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form action="{{($tipx=='new')? url('/usulhapus/store/') : url('/usulhapus/update/'.$header->NO_ID ) }}" method="POST" name ="entri" id="entri" >
                                                ...
                                                <table id="datatable" class="table table-striped table-bordered"
                                                    ...
                                                    <thead class="text-center">
                                                        <tr>
                                                            ...
                                                            <th style="width: 550px; white-space: nowrap;">Nama Suplier</th>
                                                            <th style="width: 550px; white-space: nowrap;">Keterangan</th>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input name="NAMA[]" id="NAMA{{ $no }}"
                                                                        ...
                                                                        class="form-control NAMA" required>
                                                                </td>

                                                                <td>
                                                                    <input name="KET[]" id="KET{{ $no }}"
                                                                        type="text" value="{{ $detail->KET }}"
                                                                        class="form-control KET" required>
                                                                </td>
                                    ...
                                    <div class="mt-3 col-md-12 form-group row">
                                        <div class="col-md-4">
                                            <button hidden type="button" id='TOPX'  onclick="location.href='{{url('/usulhapus/edit/?idx=' .$idx. '&tipx=top')}}'" class="btn btn-outline-primary">Top</button>
                                            <button hidden type="button" id='PREVX' onclick="location.href='{{url('/usulhapus/edit/?idx='.$header->NO_ID.'&tipx=prev&buktix='.$header->NO_BUKTI )}}'" class="btn btn-outline-primary">Prev</button>
                                            <button hidden type="button" id='NEXTX' onclick="location.href='{{url('/usulhapus/edit/?idx='.$header->NO_ID.'&tipx=next&buktix='.$header->NO_BUKTI )}}'" class="btn btn-outline-primary">Next</button>
                                            <button hidden type="button" id='BOTTOMX' onclick="location.href='{{url('/usulhapus/edit/?idx=' .$idx. '&tipx=bottom')}}'" class="btn btn-outline-primary">Bottom</button>
                                        </div>
                                        <div class="col-md-5">
                                            <button hidden type="button" id='NEWX' onclick="location.href='{{url('/usulhapus/edit/?idx=0&tipx=new')}}'" class="btn btn-warning">New</button>
                                            <button hidden type="button" id='EDITX' onclick='hidup()' class="btn btn-secondary">Edit</button>
                                            <button hidden type="button" id='UNDOX' onclick="location.href='{{url('/usulhapus/edit/?idx=' .$idx. '&tipx=undo' )}}'" class="btn btn-info">Undo</button>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <!-- <button type="button" id='CLOSEX'  onclick="location.href='{{url('/usulhapus' )}}'" class="btn btn-outline-secondary">Close</button> -->
    ...
    @section('footer-scripts')
        ...
        <script>
            ...
            $(document).ready(function() {
                    ...
                    $.ajax(
                    {
...

                        {
                            ...
                            else
                            {
                                ...
                                $("#NAMA"+rowidBarang).val(resp[0].NAMA);
                            }
                        }
                    });
                }
                ...
                chooseBarang = function(KDBAR,NMBAR, NAMA){
                    $("#KDBAR"+rowidBarang).val(KDBAR);
                    $("#NMBAR"+rowidBarang).val(NMBAR);
                    $("#NAMA"+rowidBarang).val(NAMA);
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        Swal.fire({
                            ...
                            loc = "{{ url('/usulhapus/delete/' . $header->NO_ID) }}";
            ...
            function CariBukti() {
		        ...
		        var cari = $("#CARI").val();
		        var loc = "{{ url('/usulhapus/edit/') }}" + '?idx={{ $header->NO_ID}}&tipx=search&buktix=' +encodeURIComponent(cari);
                window.location = loc;
            ...
            function tambah() {
                ...
                html = `<tr>
                        ...
                        <td>
                            <input name='NAMA[]'   id='NAMA${idrow}' type='text' class='form-control  NAMA' required>
                        </td>
                        <td>
