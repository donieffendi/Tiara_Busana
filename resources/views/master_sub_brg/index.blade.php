                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="columnToggleForm">
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="columnConter">Sub</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input column-checkbox" type="checkbox"
                                                            value="3" id="columnNama" checked>
                                                        <label class="form-check-label" for="columnNama">Kelompok</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input column-checkbox" type="checkbox"
                                                            value="4" id="columnKodeSuplier" checked>
                                                        <label class="form-check-label" for="columnKodeSuplier">Departemen</label>
                                                    </div>
                                                </form>
                                            </div>
...
@section('javascripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("div.test_btn").html(
                '<a class="btn btn-lg btn-md btn-success" href="{{ url('sub_brg/edit?idx=0&tipx=new') }}"> <i class="fas fa-plus fa-sm md-3" ></i></a'
            );
        });
