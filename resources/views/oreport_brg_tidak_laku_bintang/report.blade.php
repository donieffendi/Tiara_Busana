...
<div class="content-wrapper">
	...
	<div class="container-fluid">
		<div class="row mb-2">
		<div class="col-sm-6">
			<h1 class="m-0">Laporan Barang Tidak Laku Bertanda Bintang</h1>
		</div>
		<div class="col-sm-6">
			<ol class="breadcrumb float-sm-right">
				<li class="breadcrumb-item active">Laporan Barang Tidak Laku Bertanda Bintang</li>
			</ol>
		</div>
		</div>
	</div>
	...
	<div class="content">
		...
		<div class="row">
			...
			<div class="card">
				<div class="card-body">
					<form method="POST" action="{{url('jasper-brg_tidak_laku_bintang-report')}}">
					@csrf
					<div class="form-group row">
                        ...
                        <div class="col-md-3">
							...
							<select name="gol" id="gol" class="form-control gol">
								<option value="A" {{ session()->get('filter_gol')=='A' ? 'selected': ''}}>Stock Barang > Jumlah Order</option>
								<option value="B" {{ session()->get('filter_gol')=='B' ? 'selected': ''}}>Stock Barang < Jumlah Order</option>
								<option value="C" {{ session()->get('filter_gol')=='C' ? 'selected': ''}}>Koreksi Order</option>
							</select>
						</div>
