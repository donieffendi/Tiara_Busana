                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="entri" action="{{ url('stockb/posting') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="tab-content mt-3">
                                        ...
                                        <div class="col-md-3 input-group">
                                            ...
                                            <button type="button" id='SEARCHX' onclick="getPost()"
                                                class="btn btn-outline-primary"><i class="fas fa-search"></i></button>
                                    ...
                                    <div style="overflow-y:scroll;" class="col-md-12 scrollable" align="right">
                                        ...
                                        <table id="datatable" class="table table-striped table-border">
                                            ...
                                            <tbody id="detailPosting">
                                                <tr>
                                                    <td>
                                                        <input type="hidden" name="NO_ID[]" id="NO_ID0" type="text"
                                                            value="1" class="form-control NO_ID"
                                                    ...
                                                    <td>
                                                        <input name="NO_BUKTI[]" id="NO_BUKTI0" type="text"
                                                            value="" class="form-control NO_BUKTI" readonly>
                                                    </td>

                                                    <td>
                                                        <input name='TGLX[]' id='TGLX0' value="" type='text'
                                                            class='form-control  TGLX' required readonly>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <input name='TOTAL_QTYX[]' onblur="hitung()" id='TOTAL_QTYX0'
                                                            value="0" type='text' style='text-align: right'
                                                            class='form-control TOTAL_QTYX text-primary' readonly required>
                                                    </td>

                                                    <td>
                                                        <input name="CEKX[]" hidden value="0" id="CEKX0"
                                                            type="text" style="text-align: right"
                                                            class="form-control CEKX text-primary">
                                                        <input name="CEK[]" onchange="rubah(0)" id="CEK0"
                                                            type="checkbox" value="1" class="form-control CEK">
                                                    </td>
                                    ...
                                    <div class="col-md-2 row">
                                        <button type="button" id='simpan' onclick="simpanx()"
                                            class="btn btn-outline-primary"></i>Proses</button>
                                    </div>
    ...
    @section('footer-scripts')
        ...
        <script>
            ...
            function simpanx() {
                ...
                $.ajax({
                    url: "{{ url('stockb/posting') }}",
                    type: "POST",
                    data: $('#entri').serialize() + '&flagz=' + flag,

                    beforeSend: function() {
                        Swal.fire({
                            title: 'Proses...',
                            text: 'Sedang memposting data',
            ...
            function getPost() {
                    ...
                    success: function(resp) {
                        ...
                        for (i = 0; i < resp.length; i++) {
                            html += `<tr>
									...
									<td><input name='BUKTX[]' data-rowid=${i} id='BUKTX${i}' value="${resp[i].NO_BUKTI}" type='text' class='form-control BUKTX' readonly ></td>
                ...
                for (i = 0; i <= jumlahdata; i++) {
                    ...
                    $("#BUKTX" + i.toString()).attr("readonly", true);
