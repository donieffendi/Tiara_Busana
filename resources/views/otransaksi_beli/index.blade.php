      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <form method="POST" action="{{ url('beli/batal_post?flagz='.$flagz.'&golz='.$golz.'') }}" id="form-batal-post">
            @csrf
  ...
  $(document).ready(function() {
        ...
        $("div.test_btn").html(`
            <div class="d-flex align-items-center" style="gap: 1rem;">
                <a class="btn btn-success btn-md" href="{{ url('beli/edit?flagz=' . $flagz . '&golz=' . $golz . '&idx=0&tipx=new') }}">
