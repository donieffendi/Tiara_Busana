...
<!------- penambahan tampilan baru ------->
  ...
  <!-- batas -->
    ...
    <div class="row d-flex">
        ...
        <div class="col-md-3">
            <div class="menu-card" style="border:1px solid #aabbcc; background-color:#e3f1fc;">
              <a href="javascript:addTab('Komponen Harga Barang', '{{url('vbrgdw')}}')">
                  <!-- <i class="nav-icon fas fa-layer-group icon-green" style="text-align: center;"></i> -->
                  <i style="margin-left:-5px;font-size: 40px;" class="nav-icon fas fa-cube icon-blue"></i>
                <h6>Komponen Harga Barang</h6>
              </a>
			</div>
        </div>
...
<!------- penambahan tampilan baru ------->
    ...
    <div class="mega-menu" id="b">
      ...
      <div class="row">
        ...
        <div class="col-md-3">
            <div class="menu-card" style="border:1px solid #aabbcc; background-color:#ffe0ba;">
                <a href="javascript:addTab('Terima Retur Outlet', '{{url('terima?flagz=RM')}}')">
                  <!-- <i class="nav-icon fas fa-anchor icon-blue" style="text-align: center;"></i> -->
                  <i style="margin-left:-5px;font-size: 40px;" class="nav-icon fas fa-retweet icon-orange"></i>
...
<!------- penambahan tampilan baru ------->
    ...
    <div class="mega-menu" id="b">
      ...
      <div class="row">
        ...
        <div class="col-md-3">
            <div class="menu-card" style="border:1px solid #aabbcc; background-color:#ffe0ba;">
                <a href="javascript:addTab('Usulan Harga Beli Pemula', '{{url('vbrgdw-harga-pemula')}}')">
                  <!-- <i class="nav-icon fas fa-anchor icon-blue" style="text-align: center;"></i> -->
                  <i style="margin-left:-5px;font-size: 40px;" class="nav-icon fas fa-retweet icon-orange"></i>
                  <h6>Usulan Harga</h6>
                  <h6>Beli Pemula</h6>
      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <div class="menu-card" style="border:1px solid #aabbcc; background-color:#ffe0ba;">
              ...
              <a href="javascript:addTab('Post Beli', '{{ url('posting/index?flagz=BS') }}')">
        ...
        <div class="col-md-3">
          <div class="menu-card" style="border:1px solid #aabbcc; background-color:#ffe0ba;">
              ...
              <a href="javascript:addTab('Post Retur', '{{ url('posting/index?flagz=RO') }}')">
        ...
        <div class="col-md-3">
          <div class="menu-card" style="border:1px solid #aabbcc; background-color:#ffe0ba;">
              ...
              <a href="javascript:addTab('Post Terima Retur Outlet', '{{ url('posting/index?flagz=RM') }}')">
                <!-- <i class="nav-icon fas fa-crop icon-orange"></i> -->
                  <i style="margin-left:-5px;font-size: 40px;" class="nav-icon fas fa-file icon-orange"></i>
        ...
        <div class="col-md-3">
         ...
         <div class="col-md-3">
          <div class="menu-card" style="border:1px solid #aabbcc; background-color:#ffe0ba;">
              ...
              <a href="javascript:addTab('Post Order Outlet', '{{ url('posting/index?flagz=KO') }}')">
                <!-- <i class="nav-icon fas fa-crop icon-orange"></i> -->
                  <i style="margin-left:-5px;font-size: 40px;" class="nav-icon fas fa-file icon-orange"></i>
...
<!------- penambahan tampilan baru ------->
    ...
    <div class="mega-menu" id="k">
      ...
      <div class="row d-flex">
        ...
        <div class="col-md-3">
            <div class="menu-card" style="border:1px solid #aabbcc; background-color:#e3f1fc;">
              <a href="javascript:addTab('Pengajuan Harga Jual', '{{url('harga?flagz=HG')}}')" >
                <!-- <i class="nav-icon fas fa-anchor icon-blue" style="text-align: center;"></i> -->
                  <i style="margin-left:-5px;font-size: 40px;" class="nav-icon fas fa-paste icon-blue"></i>
                <h6>Pengajuan</h6>
                <h6>Harga Jual</h6>
        ...
        <div class="col-md-3">
            <div class="menu-card" style="border:1px solid #aabbcc; background-color:#e3f1fc;">
              {{-- <a href="javascript:addTab('Conter Pembelian', '{{url('counter?flagz=CT')}}')" > --}}
                <a href="javascript:addTab('Conter Pembelian', '{{url('counter_beli')}}')" >
                <!-- <i class="nav-icon fas fa-anchor icon-blue" style="text-align: center;"></i> -->
                  <i style="margin-left:-5px;font-size: 40px;" class="nav-icon fas fa-paste icon-blue"></i>
...
<!------- penambahan tampilan baru ------->
            ...
            <div class="mega-menu" id="f">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                    <div class="menu-card" style="border:1px solid #aabbcc; background-color:#ccffd2;">
                      <a href="javascript:addTab('Discon Penjualan', '{{url('rpantau')}}')" >
                        <!-- <i class="nav-icon fas fa-anchor icon-blue" style="text-align: center;"></i> -->
                          <i style="margin-left:-5px;font-size: 40px;" class="nav-icon fas fa-coins icon-green"></i>
                ...
                <div class="col-md-3">
                    <div class="menu-card" style="border:1px solid #aabbcc; background-color:#ccffd2;">
                      <a href="javascript:addTab('Lap. SP per PLU', '{{url('rrubahharga_discbudget')}}')" >
                        <!-- <i class="nav-icon fas fa-anchor icon-blue" style="text-align: center;"></i> -->
                          <i style="margin-left:-5px;font-size: 40px;" class="nav-icon fas fa-coins icon-green"></i>
                        <h6>Laporan Perubahan Harga</h6>
                        <h6>Beli Disc Budget</h6>
                      </a>
                    </div>
                </div>
