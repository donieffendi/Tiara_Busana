                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ url('kirim/batal_post?flagz=' . $flagz . '') }}"
                                    id="form-batal-post">
                                    @csrf


                                    <table
                                        class="table table-fixed table-striped table-border table-hover nowrap datatable"
                                        id="datatable">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            <div class="d-flex align-items-center" style="gap: 1rem;">
                <a class="btn btn-success btn-md" href="{{ url('kirim/edit?flagz=' . $flagz . '&idx=0&tipx=new') }}">
