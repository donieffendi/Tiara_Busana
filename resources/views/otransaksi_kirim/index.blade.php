      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <form method="POST" action="{{ url('kirim/batal_post?flagz='.$flagz.'&golz='.$golz.'') }}" id="form-batal-post">
            @csrf
...
<script>
  ...
  $(document).ready(function() {
        ...
        // $("div.test_btn").html('<a class="btn btn-lg btn-md btn-success" href="{{url('kirim/edit?flagz='.$flagz.'&golz='.$golz.'&idx=0&tipx=new')}}"> <i class="fas fa-plus fa-sm md-3" ></i></a');
        $("div.test_btn").html(`
            <div class="d-flex align-items-center" style="gap: 1rem;">
                <a class="btn btn-success btn-md" href="{{ url('kirim/edit?flagz=' . $flagz . '&golz=' . $golz . '&idx=0&tipx=new') }}">
