...
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form
                                    action="{{ $tipx == 'new' ? url('/kirim/store?flagz=' . $flagz . '') : url('/kirim/update/' . $header->NO_ID . '&flagz=' . $flagz . '') }}"
                                    ...
                                    <div class="tab-content mt-3">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2 input-group" hidden>
                                                <input type="text" class="form-control NCNT" id="NCNT"
                                                    ...
                                                    style="text-align: left">
                                                <button type="button" class="btn btn-primary" onclick="browseCounter()"><i
                                                        class="fa fa-search"></i></button>
                                            </div>

                                            <div class="col-md-1" align="right">
                                                <label for="OUTLET" class="form-label">Cabang Tujuan</label>
                                            </div>
                                            <div class="col-md-2">
                                                ...
                                                <select id="OUTLET" class="form-control" name="OUTLET">
                                                    ...
                                                    <option value="FSA"
                                                        {{ $header->OUTLET == 'FSA' ? 'selected' : '' }}>FSA</option>
                                                    <option value="TDY"
                                                        {{ $header->OUTLET == 'TDY' ? 'selected' : '' }}>TDY</option>
                                                    <option value="FGT"
                                                        {{ $header->OUTLET == 'FGT' ? 'selected' : '' }}>FGT</option>
                                                    <option value="FCK"
                                                        {{ $header->OUTLET == 'FCK' ? 'selected' : '' }}>FCK</option>
                                                </select>
                                            </div>

                                            <div class="col-md-1">
                                                <input type="checkbox" class="form-check-input" id="POSTED"
                                                    name="POSTED" value="1"
                                                    {{ $header->POSTED == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-1">
                                                <input type="text" class="form-control KODES" id="KODES"
                                                    name="KODES"
                                                    placeholder="Pilih Supplier"value="{{ $header->KODES }}"
                                                    style="text-align: left">
                                            </div>
                                            ...
                                            <div class="col-md-2 input-group">
                                                <input type="text" class="form-control NAMAS" id="NAMAS"
                                                    ...
                                                    style="text-align: left">
                                                <button type="button" class="btn btn-primary" onclick="browseSup()"><i
                                                        class="fa fa-search"></i></button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2 input-group">
                                                <input type="text" class="form-control REF" id="REF"
                                                    name="REF" placeholder="" value="{{ $header->REF }}"
                                            ...
                                            <div class="col-md-2 input-group">
                                                <input type="text" class="form-control HMARGIN" id="HMARGIN"
                                                    name="HMARGIN" placeholder="" value="{{ $header->MARGIN }}"
                                            ...
                                            <div class="col-md-2 input-group">
                                                <input type="text" class="form-control ST_NOTA" id="ST_NOTA"
                                                    name="ST_NOTA" placeholder="" value="{{ $header->ST_NOTA }}"
                                                    style="text-align: left" readonly>
                                            </div>
                                            ...
                                            <div class="col-md-2 input-group">
                                                <input type="text" class="form-control ST_CNT" id="ST_CNT"
                                                    name="ST_CNT" placeholder="" value="{{ $header->ST_CNT }}"
                                                    style="text-align: left" readonly>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2 input-group">
                                                <input type="text" class="form-control POT_PROM" id="POT_PROM"
                                                    name="POT_PROM" placeholder="" value="{{ $header->POT_PROM }}"
                                                    style="text-align: right" readonly>
                                            </div>
                                            ...
                                            <div class="col-md-2 input-group">
                                                <input type="text" class="form-control KK_STS" id="KK_STS"
                                                    name="KK_STS" placeholder="" value="{{ $header->KK_STS }}"
                                                    style="text-align: left" readonly>
                                            </div>
                                            ...
                                            <div class="col-md-2 input-group">
                                                <input type="text" class="form-control BASIC" id="BASIC"
                                                    name="BASIC" placeholder="" value="{{ $header->BASIC }}"
                                                    style="text-align: left" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2">
                                                <input class="form-control date" id="JTEMPO" name="JTEMPO"
                                                    data-date-format="dd-mm-yyyy" type="text" autocomplete="off"
                                                    value="{{ date('d-m-Y', strtotime($header->JTEMPO)) }}">
                                            </div>
                                            ...
                                            <div class="col-md-2 input-group">
                                                <input type="text" class="form-control ST_PJK" id="ST_PJK"
                                                    name="ST_PJK" placeholder="" value="{{ $header->ST_PJK }}"
                                                    style="text-align: left" readonly>
                                            </div>
                                            ...
                                            <div class="col-md-2 input-group">
                                                <input type="text" class="form-control FORMAL" id="FORMAL"
                                                    name="FORMAL" placeholder="" value="{{ $header->FORMAL }}"
                                                    style="text-align: left" readonly>
                                            </div>
                                            ...
                                            <div class="col-md-2 input-group">
                                                <input type="text" class="form-control NOTA_KHS" id="NOTA_KHS"
                                                    name="NOTA_KHS" placeholder="" value="{{ $header->NOTA_KHS }}"
                                                    style="text-align: left" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2">
                                                <input type="text" class="form-control NOTES" id="NOTES"
                                                    name="NOTES" placeholder="" value="{{ $header->NOTES }}" readonly>
                                            </div>

                                            <div class="col-md-1">
                                                <input type="checkbox" class="form-check-input" id="BAYAR"
                                                    name="BAYAR" value="1"
                                                    {{ $header->BAYAR == 1 ? 'checked' : '' }}>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($detail as $detail)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input name="JNS[]" id="JNS{{ $no }}"
                                                                    type="text" class="form-control JNS"
                                                                    value="{{ $detail->JNS }}">
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input name="MARGIN[]" onblur="hitung()"
                                                                    value="{{ $detail->MARGIN }}"
                                                                    id="MARGIN{{ $no }}" type="text"
                                                                    style="text-align: right" class="form-control MARGIN"
                                                                    readonly>
                                                            </td>
                                                            <td>
                                                                <input name="DIKSON1[]" onblur="hitung()"
                                                                    value="{{ $detail->DISKON1 }}"
                                                                    id="DIKSON1{{ $no }}" type="text"
                                                                    style="text-align: right" class="form-control DIKSON1"
                                                                    readonly>
                                                            </td>
                                                            <td>
                                                                <input name="DISKON2[]" onblur="hitung()"
                                                                    value="{{ $detail->DISKON2 }}"
                                                                    id="DISKON2{{ $no }}" type="text"
                                                                    style="text-align: right" class="form-control DISKON2"
                                                                    readonly>
                                                            </td>
                                                            <td>
                                                                <input name="DISKON3[]" onblur="hitung()"
                                                                    value="{{ $detail->DISKON3 }}"
                                                                    id="DISKON3{{ $no }}" type="text"
                                                                    style="text-align: right" class="form-control DISKON3"
                                                                    readonly>
                                                            </td>
                                                            <td>
                                                                <input name="DISKON4[]" onblur="hitung()"
                                                                    value="{{ $detail->DISKON4 }}"
                                                                    id="DISKON4{{ $no }}" type="text"
                                                                    style="text-align: right" class="form-control DISKON4"
                                                                    readonly>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input name="HARGA_JL[]" onblur="hitung()"
                                                                    value="{{ $detail->HARGA_JL }}"
                                                                    id="HARGA_JL{{ $no }}" type="text"
                                                                    style="text-align: right"
                                                                    class="form-control HARGA_JL" readonly>
                                                            </td>
                                                            <td>
                                                                <input name="BLT[]" onblur="hitung()"
                                                                    value="{{ $detail->BLT }}"
                                                                    id="BLT{{ $no }}" type="text"
                                                                    style="text-align: right" class="form-control BLT"
                                                                    readonly>
                                                            </td>
                                    ...
                                    <div class="tab-content mt-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2">
                                                <input type="text" onclick="select()" onkeyup="hitung()"
                                                    class="form-control TJUMLAH" id="TJUMLAH" name="TJUMLAH"
                                                    placeholder="" value="{{ $header->JUMLAH }}"
                                                    style="text-align: right" readonly>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <input type="text" onclick="select()" onkeyup="hitung()"
                                                    class="form-control TPROM" id="TPROM" name="TPROM"
                                                    placeholder="" value="{{ $header->PROM }}" style="text-align: right"
                                                    readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2">
                                                <input type="text" onclick="select()" onkeyup="hitung()"
                                                    class="form-control TDPP" id="TDPP" name="TDPP"
                                                    placeholder="" value="{{ $header->DPP }}" style="text-align: right"
                                                    readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2">
                                                <input type="text" onclick="select()" onkeyup="hitung()"
                                                    ...
                                                    placeholder="" value="{{ $header->PPN }}" style="text-align: right"
                                                    readonly>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mt-3 col-md-12 form-group row">
                                        <div class="col-md-4">
                                            <button hidden type="button" id='TOPX'
                                                onclick="location.href='{{ url('/kirim/edit/?idx=' . $idx . '&tipx=top&flagz=' . $flagz . '') }}'"
                                                class="btn btn-outline-primary">Top</button>
                                            <button hidden type="button" id='PREVX'
                                                onclick="location.href='{{ url('/kirim/edit/?idx=' . $header->NO_ID . '&tipx=prev&flagz=' . $flagz . '&buktix=' . $header->NO_BUKTI) }}'"
                                                class="btn btn-outline-primary">Prev</button>
                                            <button hidden type="button" id='NEXTX'
                                                onclick="location.href='{{ url('/kirim/edit/?idx=' . $header->NO_ID . '&tipx=next&flagz=' . $flagz . '&buktix=' . $header->NO_BUKTI) }}'"
                                                class="btn btn-outline-primary">Next</button>
                                            <button hidden type="button" id='BOTTOMX'
                                                onclick="location.href='{{ url('/kirim/edit/?idx=' . $idx . '&tipx=bottom&flagz=' . $flagz . '') }}'"
                                                class="btn btn-outline-primary">Bottom</button>
                                        </div>
                                        <div class="col-md-5">
                                            <button hidden type="button" id='NEWX'
                                                onclick="location.href='{{ url('/kirim/edit/?idx=0&tipx=new&flagz=' . $flagz . '') }}'"
                                            ...
                                            <button hidden type="button" id='UNDOX'
                                                onclick="location.href='{{ url('/kirim/edit/?idx=' . $idx . '&tipx=undo&flagz=' . $flagz . '') }}'"
    ...
    <div class="modal fade" id="browseCounterModal" tabindex="-1" role="dialog"
        aria-labelledby="browseCounterModalLabel" aria-hidden="true">
...
@section('footer-scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            document.addEventListener('keydown', function(e) {
                if (e.key === 'Enter') {
                    ...
                    let input = document.getElementById('NO_PO');

                    if (document.activeElement === input) {
                        let no_po = input.value;
            ...
            $("HMARGIN").autoNumeric('init', {
                aSign: '<?php echo ''; ?>',
                vMin: '-999999999.99'
            });
            $("#POT_PROM").autoNumeric('init', {
                aSign: '<?php echo ''; ?>',
                vMin: '-999999999.99'
            });
            ...
            for (i = 0; i <= jumlahdata; i++) {
                ...
                $("#XQTY" + i.toString()).autoNumeric('init', {
                    aSign: '<?php echo ''; ?>',
                    vMin: '-999999999.99'
                });
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        for (i = 0; i < resp.length; i++) {
                            ...
                            dTableBSup.row.add([
                                '<a href="javascript:void(0);" onclick="chooseSup(\'' +
                    ...
                    success: function(response) {
                        ...
                        for (i = 0; i < resp.length; i++) {
                            ...
                            dTableBCounter.row.add([
                                '<a href="javascript:void(0);" onclick="chooseCounter(\'' +
                                resp[i].CNT + '\', \'' + resp[i].NCNT + '\')">' + resp[i]
                                .CNT + '</a>',
                                resp[i].NCNT
                            ]);
                        }
                        ...
                        if (resp.length > 1) {
                            ...
                            for (i = 0; i < resp.length; i++) {
                                ...
                                dTableBBarang.row.add([
                                    ...
                                    resp[i].KD_BRG + '\', \'' + resp[i].NA_BRG + '\',\'' + resp[
                                        i].BARCODE + '\',\'' + resp[i].HARGA_JL + '\',\'' +
                                    resp[i].HARGA + '\',\'' + resp[i].JNS + '\',\'' + resp[i]
                                    .MARGIN + '\')">' + resp[i].KD_BRG + '</a>',
                                    resp[i].NA_BRG,
                                ]);
                            }
                            dTableBBarang.draw();
            ...
            chooseBarang = function(KD_BRG, NA_BRG, BARCODE, HARGA_JL, HARGA, JNS, MARGIN) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        ...
                        loc = "{{ url('/kirim/delete/' . $header->NO_ID) }}" + '?flagz=' +
        ...
        function CariBukti() {
            ...
            var flagz = "{{ $flagz }}";
            var cari = $("#CARI").val();
            var loc = "{{ url('/kirim/edit/') }}" + '?idx={{ $header->NO_ID }}&tipx=search&flagz=' + encodeURIComponent(
